                ...
                <div class="row gx-5 align-items-center">
                    <div class="col-md-5">
                        ...
                        <div class="text-center text-md-start">
                            ...
                            <div class="fs-3 fw-light text-muted">PENGUMUMAN KELULUSAN</div>
                            ...
                            <form method="post" action="loading.php">
                                <div class="form-floating mb-3">
                                    <input type="number" id="inputnisn" class="form-control" placeholder="nisn" required="required" name="nisn">
                                    <label for="name">NISN</label>
                                    <div class="invalid-feedback" data-sb-feedback="name:required">Silahkan Masukan Nisn Anda.</div>
                                </div>
                                <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-md-start mb-3">
                                    <input class="btn btn-primary" type="submit" value="CARI">
                                    <button class="btn btn-outline-dark btn-lg px-5 py-3 fs-6 fw-bolder" type="reset">DELETE</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    <div class="col-lg-7">
                        ...
                        <div class="d-flex justify-content-center mt-5 mt-md-0">
                            <div class="profile bg-gradient-primary-to-secondary">
                                ...
                                <img class="profile-img" src="assets/website.png" alt="..." />
                                <div class="dots-1">
                                    <!-- SVG Dots-->
